...
$where = $gradeFilter ? "WHERE LockerGrade = '".$mysqli->real_escape_string($gradeFilter)."'" : '';
...
<body class="d-flex flex-column min-vh-100">
  ...
  <?php if ($gradeFilter): ?>
    <a href="mis_reports.php" class="btn btn-outline-secondary btn-sm">Reset</a>
  <?php endif; ?>
</form>
...
<tr class="fw-bold">
  ...
  <td><?= esc($grandTotals['Maintenance']) ?></td>
