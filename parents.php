...
if (isset($_POST['login'])) {
    ...
    // Now check BOTH email and password in the query
    $sql = "SELECT ParentID, ParentName, ParentEmail, Password 
            FROM parents 
...
<div class="container d-flex justify-content-center align-items-center" style="min-height:100vh;">
  <div class="card card-glass p-4 col-md-5">
    ...
    <p class="mt-3">No account? <a href="/amandla-lockersystem/parents/parent.register.php" class="text-light">Register here</a></p>
  </div>
</div>
