...
require_once __DIR__ . '/../includes/functions.php';     // registerStudent(), applyForLockerAdmin(), cancelBooking()
require_once __DIR__ . '/../includes/parentmailer.php';  // mailer wrappers
